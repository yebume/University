...
void SetupIRQ12 ()
{
    ...
    *((volatile unsigned int *) 0x30024)|= (0x00020000) | (0x00040000);
...
void Irq1ISR (int i)
{
    ...
    SetupSPI1835 () ;
    leftDAC4Vol = Get1835Register ((0x0800) | (0x8000)) ;
    rightDAC4Vol = Get1835Register ((0x0800) | (0x9000)) ;
    ...
    if (leftDAC4Vol > 0)
        Configure1835Register ((0x0000) | (0x8000) | leftDAC4Vol) ;

    if (rightDAC4Vol > 0)
        Configure1835Register ((0x0000) | (0x9000) | rightDAC4Vol) ;

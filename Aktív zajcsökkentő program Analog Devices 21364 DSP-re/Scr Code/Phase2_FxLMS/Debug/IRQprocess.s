...
//  Compiler options: -c -file-attr ProjectName=FxLMS_with_A3_minden_hat_dec -O -Ov100 -g -save-temps -path-output Debug -ED -no-multiline -double-size-32 -flags-compiler --diag_warning,implicit_func_decl -warn-protos -force-circbuf -proc ADSP-21364 -o Debug\IRQprocess.doj -MM
...
.epcdebug:
	...
	.var =
		...
		0x00,0x01,0x84,0x01,0x00,0x00,0x04,0x3B,0x02,0x00,0x00,0x53,
		0x65,0x74,0x75,0x70,0x49,0x52,0x51,0x31,0x32,0x00,0x01;
	.var = .LN_SetupIRQ12;
	...
	.var = .LN._SetupIRQ12.end;
	.var =
		0x00,0x00,0x04,0xA3,0x02,0x00,0x00,0x49,0x72,0x71,0x31,0x49,
		0x53,0x52,0x00,0x01;
	.var = .LN_Irq1ISR;
	.var = .LN._Irq1ISR.end;
	.var =
		0x01,0x01,0x00,0x06,0x69,0x00,0x84,0x01,0x00,0x00,0x02,0x86,
		0x7E,0x00,0x05,0x00,0x00,0x00,0x00;
	.var = .LN6;
	.var = .LN._Irq1ISR.end;
	.var =
		0x07,0x6C,0x65,0x66,0x74,0x44,0x41,0x43,0x34,0x56,0x6F,0x6C,
		0x00,0x01,0x84,0x01,0x00,0x00,0x02,0x86,0x7C,0x00,0x00,0x00,
		0x00,0x00,0x07,0x72,0x69,0x67,0x68,0x74,0x44,0x41,0x43,0x34,
		0x56,0x6F,0x6C,0x00,0x01,0x84,0x01,0x00,0x00,0x02,0x86,0x7D,
...
.epcline:
	...
	.var =
		...
		0x63,0x00,0x00,0x96,0x99,0xBF,0xD1,0x04,0xCA,0x11,0x74,0x74,
		0x2E,0x68,0x00,0x00,0xB0,0xF5,0x84,0x93,0x06,0xAC,0x0F,0x43,
		...
		0xD2,0xE0,0xD8,0xA3,0x04,0xAF,0x04,0x43,0x3A,0x5C,0x50,0x72,
		...
		,
...
.epcpubnames:
	...
	.var = .epcdebug;
	.var =
		0x0C,0x03,0x00,0x00,0x10,0x02,0x00,0x00,0x53,0x65,0x74,0x75,
		0x70,0x49,0x52,0x51,0x31,0x32,0x00,0x3B,0x02,0x00,0x00,0x49,
		0x72,0x71,0x31,0x49,0x53,0x52,0x00,0xA3,0x02,0x00,0x00,0x49,
...
.epcannot:
	...
	.var =
		0x01,0x00,0x00,0x00,0xF8,0x03,0x00,0x00,0x2D,0x00,0x00,0x00,
		...
		0x20,0x4D,0x61,0x79,0x20,0x30,0x38,0x20,0x31,0x38,0x3A,0x33,
		0x32,0x3A,0x30,0x35,0x20,0x32,0x30,0x32,0x33,0x0A,0x00,0x39,
		0x00,0x00,0x00,0x67,0x01,0x00,0x00,0x19,0x00,0x00,0x00,0x01,
		...
		0x69,0x74,0x68,0x5F,0x41,0x33,0x5F,0x6D,0x69,0x6E,0x64,0x65,
		0x6E,0x5F,0x68,0x61,0x74,0x5F,0x64,0x65,0x63,0x20,0x2D,0x4F,
		...
		,
		...
		,
		...
		0x7D,0x00,0x7A,0x03,0x00,0x00,0x00,0x00;
.epcannot.end:

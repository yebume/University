...
unsigned int Block_A[2] ;
unsigned int Block_B[2] ;
unsigned int Block_C[2] ;
...
void InitSPORT()
{
    ...
    *((volatile unsigned int *) 0xc04) = 0;
    *((volatile unsigned int *) 0x404) = 0;

    *((volatile unsigned int *) 0xc00) = 0 ;
    *((volatile unsigned int *) 0xc01) = 0 ;
    *((volatile unsigned int *) 0x400) = 0 ;
    ...
    *((volatile unsigned int *) 0xc01) = ((0x02000000) | (0x00000800) | (0x00000010|0x00000020|0x00000040|0x00000100) | (0x00000001) | (0x00800000)  | (0x00000002)  ) ;
    *((volatile unsigned int *) 0xc64) = 10;
    *((volatile unsigned int *) 0xc64) = 10;
    ...
    *((volatile unsigned int *) 0xc01) |= ((0x02000000) | (0x00000800) | (0x00000010|0x00000020|0x00000040|0x00000100) | (0x01000000) | (0x00800000)  | (0x00000002)  ) ;
    *((volatile unsigned int *) 0xc66) = 0;
    *((volatile unsigned int *) 0xc66) = 0;
    ...
    *((volatile unsigned int *) 0x400) = ((0x02000000) | (0x00000800) | (0x00000010|0x00000020|0x00000040|0x00000100) | (0x00000001) | (0x00800000)  | (0x00000002)  ) ;
    *((volatile unsigned int *) 0x460) = 0;
    *((volatile unsigned int *) 0x460) = 0;
    ...
    *((volatile unsigned int *) 0x400) |= ((0x02000000) | (0x00000800) | (0x00000010|0x00000020|0x00000040|0x00000100) | (0x01000000) | (0x00800000)  | (0x00000002)  ) ;
    *((volatile unsigned int *) 0x462) = 0;
    *((volatile unsigned int *) 0x462) = 0;
    ...
    *((volatile unsigned int *) 0xc00) = ((0x00800000) | (0x00000800) | (0x00000010|0x00000020|0x00000040|0x00000100) | (0x00000001) | (0x00080000) | (0x00040000) | (0x00000002));

    
    
    *((volatile unsigned int *) 0xc43) = (unsigned int) TCB_Block_A - OFFSET + 3 + PCI;  

...
pmctlsetting = *((volatile unsigned int *) 0x2000);
pmctlsetting &= ~(0x3f);

pmctlsetting |= (0x00000001|0x00000002|0x00000008|0x00000010) | (0x00000040) | (0x00000200) | (0x00008000) ;

*((volatile unsigned int *) 0x2000) = pmctlsetting;

for (i=0;i<4096;i++)
          asm("nop;");

*((volatile unsigned int *) 0x2000) ^= (0x00008000); 
*((volatile unsigned int *) 0x2000) |= ((0x00001000));  
}
